...
/usr/libexec/PlistBuddy -c "Add :CFBundleName string GRB Window Recorder" "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleDisplayName string GRB Window Recorder" "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleIdentifier string com.blackmamba.grbwindowrecorder" "$CONTENTS/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :NSMicrophoneUsageDescription string GRB Window Recorder necesita el micrófono para incluir audio en tus grabaciones." "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :NSAudioCaptureUsageDescription string GRB Window Recorder necesita capturar el audio del sistema cuando lo activas." "$CONTENTS/Info.plist"
