...
/usr/libexec/PlistBuddy -c "Add :CFBundleName string GRB Window Rec" "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleDisplayName string GRB Window Rec" "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleIdentifier string com.blackmamba.grbwindowrec" "$CONTENTS/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :NSMicrophoneUsageDescription string GRB Window Rec necesita el micrófono para incluir audio en tus grabaciones." "$CONTENTS/Info.plist"
